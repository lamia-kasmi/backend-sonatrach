"""
Django settings for affectation_service project.
...
SECRET_KEY = 'django-insecure-v*h*yh8zaz=klnsvh&vrto+g6gdrc730q-ze)o)eyz=#^%q3h('
...
ROOT_URLCONF = 'affectation_service.urls'
import os
BASE_DIR = Path(__file__).resolve().parent.parent
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'affectation_service.wsgi.application'
